...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        webview.settings.userAgentString += "Codeaft"
        ...
        if ((this@MainActivity.getSystemService(CONNECTIVITY_SERVICE) as ConnectivityManager).activeNetwork == null) {
            ...
            webview.loadUrl("https://codeaft.github.io")
        }
        webview.webViewClient = object : WebViewClient() {
            override fun shouldOverrideUrlLoading(
                ...
                if (url.startsWith("https://codeaft.github.io")) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (webview.title.toString() == "Codeaft")
                    finishAffinity()
